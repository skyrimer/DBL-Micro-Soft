...
data = pd.read_excel("_6_Categorisation\clean_labels.xlsx").query("Category != 'Undefined category'")
...
joblib.dump(svm_model, r"_8_PerformanceEvaluation\svm_model.joblib")
joblib.dump(tfidf_vectorizer, r"_6_Categorisation\tfidf_vectorizer.joblib")
joblib.dump(tfidf_vectorizer, r"_8_PerformanceEvaluation\tfidf_vectorizer.joblib")
joblib.dump(label_encoder, r"_6_Categorisation\label_encoder.joblib")
joblib.dump(label_encoder, r"_8_PerformanceEvaluation\label_encoder.joblib")
